...
const string strMessageMagic = "KangarooBits2 Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 10 * COIN; //initialize Subsidy

            if(nBestHeight == 0)
            {
            nSubsidy = 100000000 * COIN; //Premine for KGB2
            }

	    else if (nBestHeight < 100)
   	    {
    	    nSubsidy = 0 * COIN;  // Fair launch no instamine
    	    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "KangarooBits2", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "01-october-2017";
        CTransaction txNew;
        txNew.nTime = 1506835649;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506835649;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 20158 : 20158;
        ...
        assert(block.hashMerkleRoot == uint256("0x996ff93e7373edd101a80158526999ff86ffcfaebdae85d293386cc3d6b3d5b0"));
